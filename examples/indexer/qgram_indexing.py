...
tk.q_gram_blocking(iter1=fi1, q1=[3], value_path1=['name[*].value'], output_file_path='ima_qgrams.json' )
...
tk.q_gram_blocking(iter1=fu1, q1=[3], value_path1=['name[*].value'], iter2=fi2,
