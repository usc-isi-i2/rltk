...
tk.q_gram_blocking(file_iter1=fi1, q1=[3], value_path1=['name[*].value'], output_file_path='../results/ima_qgrams.json' )
...
tk.q_gram_blocking(file_iter1=fu1, q1=[3], value_path1=['name[*].value'], file_iter2=fi2, 
 q2=[3], value_path2=['name[*].value'], output_file_path='../results/qgram_ulan_gm.json' )
