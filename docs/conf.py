...
latex_documents = [
    (master_doc, 'rltk.tex', u'RLTK Documentation',
     u'USC/ISI', 'manual'),
]
...
man_pages = [
    (master_doc, 'rltk', u'RLTK Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'rltk', u'RLTK Documentation',
     author, 'rltk', 'One line description of project.',
     'Miscellaneous'),
]